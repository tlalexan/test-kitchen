...
require 'kitchen/driver/compression/base'
require 'kitchen/driver/compression/none'
require 'kitchen/driver/compression/tar'
require 'kitchen/driver/compression/gzip'
require 'kitchen/driver/compression/seven_zip'
